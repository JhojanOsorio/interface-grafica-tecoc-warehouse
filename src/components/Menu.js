...
<Modal.Title>
  ...
  <div class="form-group fw-bolder">
    ...
    <input type="date" class="form-control" id="formGroupExampleInput2" placeholder=""></input>
  ...
  <div class="form-group fw-bolder">
    ...
    <input type="file" class="custom-file-input" id="customFile  " className="btn btn-primary"></input>
        ...
        <Modal.Footer>
          <Button  id="cerrar" variant="primary" className="fw-bolder" onClick={handleClose}>
            Cancelar
          </Button>
          <Button  id="guardar" variant="primary"   className=" fw-bolder">Guardar</Button>
        </Modal.Footer>
      </Modal>
    </>
  );
